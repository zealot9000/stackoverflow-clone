    ...
    context 'Authenticated user' do
      ...
      context 'with valid attributes' do
        ...
        it 'changes answer attributes' do
          ...
          patch :update, id: answer, answer: { body: updated_body }, format: :js
          answer.reload
      ...
      context 'with invalid attributes' do
        ...
        before do
          patch :update, id: answer, answer: { body: invalid_body }, format: :js
        end
      ...
      context 'User is not author' do
        ...
        it 'try update answer' do
          ...
          patch :update, id: another_answer, answer: { body: updated_body }, format: :js
